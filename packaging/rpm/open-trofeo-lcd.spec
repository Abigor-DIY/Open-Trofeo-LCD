...
install -Dm644 packaging/flatpak/io.github.abigordiy.open-trofeo-lcd.svg %{buildroot}%{_datadir}/icons/hicolor/scalable/apps/io.github.abigordiy.open-trofeo-lcd.svg
install -Dm644 packaging/flatpak/io.github.abigordiy.open-trofeo-lcd.metainfo.xml %{buildroot}%{_datadir}/metainfo/io.github.abigordiy.open-trofeo-lcd.metainfo.xml
...
%files
%license LICENSE
%doc README.md docs/flatpak.md docs/linux-packaging.md docs/gaming-fps.md docs/third-party-licenses.md
%{_bindir}/open-trofeo-lcd
%{_datadir}/open-trofeo-lcd
%{_datadir}/applications/open-trofeo-lcd.desktop
%{_datadir}/icons/hicolor/scalable/apps/io.github.abigordiy.open-trofeo-lcd.svg
%{_datadir}/metainfo/io.github.abigordiy.open-trofeo-lcd.metainfo.xml
