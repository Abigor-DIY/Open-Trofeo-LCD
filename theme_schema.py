...
KNOWN_STAT_SOURCES = [
    ...
    "audio_eq_bars", "audio_eq_raw_bars", "audio_eq_source", "audio_eq_status", "audio_eq_age_ms",
    "game_active", "game_name", "game_process", "game_launcher", "game_fps", "game_frametime_ms", "game_fps_source", "game_overlay",
...
def _normalize_stat_item(raw: Any, idx: int) -> dict[str, Any]:
    ...
    equalizer_bars = int(_expect_number(data.get("equalizer_bars", 18), f"{path}.equalizer_bars"))
