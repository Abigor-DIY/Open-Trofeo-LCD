...
- Status: w trakcie. Canvas obsluguje zaznaczanie, przesuwanie, skalowanie z uchwytami naroznymi i bocznymi, crop dla obrazow, snap, undo/redo, kompaktowy inspector/Weather, grupowe presety pozycji, szybkie akcje warstw oraz edycje przezroczystosci dla obrazow, paneli i widgetow.
